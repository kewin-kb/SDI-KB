...
public class CRUD {
    ...
    public boolean buscarUsuario(String nombre, String contrasena) throws SQLException {
        ResultSet rs = stmt.executeQuery("SELECT * FROM usuarios WHERE nombre_completo='" + nombre +"'");
        if (!rs.isBeforeFirst()) {
